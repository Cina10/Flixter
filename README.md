...
* [X] Added image to movie detail page
...
around the image larger, without actually making the image larger. I attempted to blow up the background image, for example,
in the movies details page by fiddling with the XML settings, and eventually I got the image to fit the page, but I'm not entirely sure why
the changes I made changed the size of the image image and how to control it for the landscape version.
